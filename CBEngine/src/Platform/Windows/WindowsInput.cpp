...
namespace CB
{
	...
	std::pair<float, float> WindowsInput::GetMouseDeltaImpl() { return {m_FrameMouseDeltaX, m_FrameMouseDeltaY}; }

	std::pair<float, float> WindowsInput::GetMouseScrollDeltaImpl() { return {m_FrameScrollX, m_FrameScrollY}; }
