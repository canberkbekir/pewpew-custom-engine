...
namespace CB
{
	...
	String OpenGLShader::ReadFile(const String& filepath)
	{
		...
		if (in) {
			...
			else { CB_CORE_ERROR("Could not read from file '{0}'", filepath); }
		}
		else { CB_CORE_ERROR("Could not open file '{0}'", filepath); }
	...
	void OpenGLShader::SetFloat2(const String& name,const Vector2& value) { UploadUniformFloat2(name, value); }

	void OpenGLShader::SetFloat3(const String& name,const Vector3& value) { UploadUniformFloat3(name, value); }

	void OpenGLShader::SetFloat4(const String& name,const Vector4& value) { UploadUniformFloat4(name, value); }

	void OpenGLShader::SetMat3(const String& name,const Mat3& matrix) { UploadUniformMat3(name, matrix); }
