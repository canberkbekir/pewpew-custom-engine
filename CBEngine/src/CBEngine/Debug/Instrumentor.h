...
namespace CB
{
	...
	public:
		...
		float GetFrameTimeMs() const { return m_LastFrameTime; }

		const std::vector<ProfileResult>& GetCurrentFrameScopes() const { return m_LastFrameScopes; }
	...
	private:
		Instrumentor()
			: m_CurrentSession(nullptr) { m_FrameTimeHistory.fill(0.0f); }
