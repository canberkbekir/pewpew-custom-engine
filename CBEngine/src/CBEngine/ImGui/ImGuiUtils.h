...
namespace CB
{
    inline void SetupImGuiStyle()
    {
        ...
        // ---------------------------------------------------------------------
        constexpr ImVec4 Base = {0.117f, 0.117f, 0.172f, 1.0f}; // #1e1e2e
        constexpr ImVec4 Mantle = {0.109f, 0.109f, 0.156f, 1.0f}; // #181825

        constexpr ImVec4 Surface0 = {0.200f, 0.207f, 0.286f, 1.0f}; // #313244
        constexpr ImVec4 Surface1 = {0.247f, 0.254f, 0.337f, 1.0f}; // #3f4056
        constexpr ImVec4 Surface2 = {0.290f, 0.301f, 0.388f, 1.0f}; // #4a4d63

        constexpr ImVec4 Overlay0 = {0.396f, 0.403f, 0.486f, 1.0f}; // #65677c
        constexpr ImVec4 Overlay2 = {0.576f, 0.584f, 0.654f, 1.0f}; // #9399b2

        constexpr ImVec4 Text = {0.803f, 0.815f, 0.878f, 1.0f}; // #cdd6f4
        constexpr ImVec4 Subtext0 = {0.639f, 0.658f, 0.764f, 1.0f}; // #a3a8c3

        constexpr ImVec4 Mauve = {0.796f, 0.698f, 0.972f, 1.0f}; // #cba6f7
        constexpr ImVec4 Peach = {0.980f, 0.709f, 0.572f, 1.0f}; // #fab387
        constexpr ImVec4 Yellow = {0.980f, 0.913f, 0.596f, 1.0f}; // #f9e2af
        constexpr ImVec4 Green = {0.650f, 0.890f, 0.631f, 1.0f}; // #a6e3a1
        constexpr ImVec4 Teal = {0.580f, 0.886f, 0.819f, 1.0f}; // #94e2d5
        constexpr ImVec4 Sapphire = {0.458f, 0.784f, 0.878f, 1.0f}; // #74c7ec
        constexpr ImVec4 Blue = {0.533f, 0.698f, 0.976f, 1.0f}; // #89b4fa
        constexpr ImVec4 Lavender = {0.709f, 0.764f, 0.980f, 1.0f}; // #b4befe
