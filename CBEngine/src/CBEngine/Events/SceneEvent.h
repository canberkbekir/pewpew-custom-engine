...
namespace CB
{
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "EntityCreatedEvent: " << m_Name << " [" << (uint64_t)m_EntityUUID << "]";
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "EntityDestroyedEvent: " << m_Name << " [" << (uint64_t)m_EntityUUID << "]";
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "ComponentAddedEvent: " << m_ComponentName << " on entity [" << (uint64_t)m_EntityUUID << "]";
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "ComponentRemovedEvent: " << m_ComponentName << " on entity [" << (uint64_t)m_EntityUUID << "]";
			return ss.str();
		}
