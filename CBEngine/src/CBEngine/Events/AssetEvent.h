...
namespace CB
{
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "AssetImportedEvent: " << AssetTypeToString(m_AssetType) << " [" << (uint64_t)m_UUID << "] " << m_Path.string();
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "AssetDeletedEvent: " << AssetTypeToString(m_AssetType) << " [" << (uint64_t)m_UUID << "] " << m_Path.string();
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "AssetRenamedEvent: [" << (uint64_t)m_UUID << "] " << m_OldPath.string() << " -> " << m_NewPath.string();
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "AssetMovedEvent: [" << (uint64_t)m_UUID << "] " << m_OldPath.string() << " -> " << m_NewPath.string();
			return ss.str();
		}
	...
	public:
		...
		{
			std::stringstream ss;
			ss << "AssetReloadedEvent: " << AssetTypeToString(m_AssetType) << " [" << (uint64_t)m_UUID << "]";
			return ss.str();
		}
	...
	{
	public:
		DragDropDeliverEvent(const std::string& payloadType, const std::string& sourcePath, const std::string& targetPath)
