...
namespace CB
{
	...
	template <typename... Ts>
	void SerializeAll(YAML::Emitter& out,Entity entity,ComponentList<Ts...>) { (TrySerialize<Ts>(out, entity), ...); }

	inline void SerializeAll(YAML::Emitter& out,Entity entity) { SerializeAll(out, entity, SerializableComponents{}); }
	...
	template <typename... Ts>
	void ResolveAssetsAll(Entity entity,ComponentList<Ts...>) { (TryResolveAssets<Ts>(entity), ...); }

	inline void ResolveAssetsAll(Entity entity) { ResolveAssetsAll(entity, SerializableComponents{}); }
}