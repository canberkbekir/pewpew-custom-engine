...
namespace CB
{
	...
	void PerspectiveCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(CB_BIND_EVENT_FN(PerspectiveCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(CB_BIND_EVENT_FN(PerspectiveCameraController::OnWindowResized));
	}
